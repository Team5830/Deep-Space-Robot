...
public class ManipulatorMiddleHatchP extends Command {
  public ManipulatorMiddleHatchP() {
  ...
  protected void execute() {
    ...
    Robot.MANIPULATOR.setSetpoint(5000); //TODO Calibrate this number or you will kill the robot.
