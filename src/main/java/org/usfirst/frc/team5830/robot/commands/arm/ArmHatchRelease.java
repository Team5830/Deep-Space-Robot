...
public class ArmHatchRelease extends Command {
  public ArmHatchRelease() {
    requires(Robot.ARM);
  ...
  protected void execute() {
    ...
    if(Robot.isArmAutomatic) {
      //Robot.armSetpointRaw = Robot.armSetpointRaw - 0;
      Robot.manipulatorSetpointRaw = Robot.manipulatorSetpointRaw + 150;
      Robot.ARM.enable();
