    ...
    protected void execute() {
		...
		switch (Robot.controlType.getSelected()) {
			...
			//Pneumatics Test (Right Flightstick)
				...
				Robot.Cargo = new JoystickButton(Robot.leftJoy, 3);
				Robot.ArmLow = new JoystickButton(Robot.leftJoy, 4);
				Robot.ArmMiddle = new JoystickButton(Robot.leftJoy, 5);
				Robot.ArmHigh = new JoystickButton(Robot.leftJoy, 6);
				Robot.ArmDefault = new JoystickButton(Robot.leftJoy, 7);
				Robot.Floor = new JoystickButton(Robot.leftJoy, 8);
				//Robot.LoadingStation = new JoystickButton(Robot.arduino, 7);
				Robot.Vacuum = new JoystickButton(Robot.leftJoy, 9);
